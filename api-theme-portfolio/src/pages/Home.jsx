    ...
    <Layout>
      <div className="content">
        ...
        <div className="social-links">
          <a href="https://github.com/berylxo" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/berylcatieno/" target="_blank" rel="noopener noreferrer">
          ...
          <a href="/assets/Beryl_Atieno_CV.pdf" className="endpoint" download="Beryl_Atieno_CV.pdf">résumé</a>
        </div>
      </div>
    </Layout>
  );
